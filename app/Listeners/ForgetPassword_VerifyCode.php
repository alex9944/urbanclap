...
class ForgetPassword_VerifyCode
{
    /**
	...
	protected function _sendMailToUser($user)
	{
		...
		Mail::send('emails.forget_password_verification', $mail_content, function($message)use ($mail_content) 
		{
			...
			$message->subject($site_name . ' | Forget Password Verification Code');
	...
	{
		$msg = 'Please use the verification code to reset your password: ' . $user->verification_code;
