...
class PaypalLibray {
	...
	function __construct($business_email = '', $currency_code = 'USD', $mode = 'test')
	{
		$this->currency_code = $currency_code;
		
		$this->paypal_url = ($mode == 'test')?'https://www.sandbox.paypal.com/cgi-bin/webscr':'https://www.paypal.com/cgi-bin/webscr';
	...
	function button($value)
	{
		...
		$this->submit_btn = \Form::submit($value, array('name' => 'pp_submit'));
	}
	...
	function paypal_form($form_name='paypal_form') 
	{
		...
		$str .= '<p class="text-center">'. $this->submit_btn . '</p>';
		$str .= \Form::close() . "\n";
	...
	{//echo "https://finance.google.com/finance/converter?a=$amount&from=$from_Currency&to=$to_Currency";
