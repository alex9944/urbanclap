            ...
            <div class="row">
					...
					<!-- <div class="col-md-12 col-xs-12">
					 ...
					 <div class="col-md-5 col-xs-12">
								<div class="x_panel">
								<form name="actionForm" action="<?php echo e(url('admin/blog/destroy')); ?>" method="post" onsubmit="return deleteConfirm();"/> 
					...
					<?php $__currentLoopData = $blogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blogs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="rm<?php echo e($blogs->b_id); ?>">
                          <td>
						  <input type="checkbox" name="selected_id[]" class="checkbox" value="<?php echo e($blogs->b_id); ?>"/>				 	  
						  </td>
                          <td><?php echo e($blogs->b_title); ?></td>
                         <td>
						 <!--<a href="#" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> View </a>-->
                            <a href="javascript:void(0);" class="edit_blog btn btn-info btn-xs" id="<?php echo e($blogs->b_id); ?>" ><i class="fa fa-pencil"></i> Edit </a>
                            <a href="javascript:void(0);" class="btn btn-danger btn-xs delete_blog" id="<?php echo e($blogs->b_id); ?>"><i class="fa fa-trash-o"></i> Delete </a></td>
                        </tr> 
					...
					<div class="x_panel" id="add_div" style="">
						...
						<div class="alert alert-success hidden"></div>
								  <!-- Add Form Start-->
						 <form method="POST" action="<?php echo e(url('admin/blog/added')); ?>" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal">
                      
                            <div id="reportArea">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label"> Blog Name</label>
                                    <div class="col-sm-6">
                                        <input class="form-control" type="text" name="b_title" id="b_title" value="<?php echo e(old('b_title')); ?>"/>
										<span class="error"><?php echo e(($errors->has('b_title')) ? $errors->first('b_title') : ''); ?></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" type="text" name="b_slug" id="b_slug" value="<?php echo e(old('b_slug')); ?>" />
										<span class="error"><?php echo e(($errors->has('b_slug')) ? $errors->first('b_slug') : ''); ?></span>
                                    </div>
                                </div>
								 <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
										...
										<span class="error"><?php echo e(($errors->has('photo')) ? $errors->first('photo') : ''); ?></span>
                                    </div>
                                </div>
								<div class="form-group">
                                    <label class="col-sm-2 control-label">Meta Tag</label>
                                    <div class="col-sm-6">
                                        <textarea name="b_meta_tag" class="form-control" id="b_meta_tag"><?php echo e(old('b_meta_tag')); ?></textarea>
                                    </div>
                                </div>
								<div class="form-group">
                                    <label class="col-sm-2 control-label">Meta Description</label>
                                    <div class="col-sm-6">
                                        <textarea class="form-control" name="b_meta_description" id="b_meta_description"><?php echo e(old('b_meta_description')); ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <textarea  class="tinymce" id="b_description" name="b_description"><?php echo e(old('b_description')); ?></textarea>
										<span class="error"><?php echo e(($errors->has('b_description')) ? $errors->first('b_description') : ''); ?></span>
                                    </div>
                                </div>
					...
					<div class="x_panel" id="edit_div" style=" display:none">
						...
						<div class="x_title">
								  ...
								  <!-- Edit Form Start-->
						 <form method="POST" action="<?php echo e(url('admin/blog/updated')); ?>"  enctype="multipart/form-data" class="form-horizontal">
...
// Add Blog
	...
	function add_blog(){  
	var host='<?php echo e(url('admin/blog/get_users')); ?>';
	var id= $(this).attr('id');  
	$('#edit_div').hide();
	$('#add_div').fadeIn("slow");	
 ...
 $(document).on("click", ".edit_blog", edit_blogs);
  ...
  var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
   var id= $(this).attr('id'); 
	...
	var host="<?php echo e(url('admin/blog/getblogs/')); ?>";
	$('#add_div').hide();
...
var image_path=res.view_details.b_image;
 ...
 $(document).on("click", ".delete_blog", deleteblog);
  ...
  var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
   var id= $(this).attr('id'); 
	var host="<?php echo e(url('admin/blog/deleted/')); ?>";
	$.ajax({
		type: 'POST',
		data:{'id': id,'_token':CSRF_TOKEN},
		url: host,
