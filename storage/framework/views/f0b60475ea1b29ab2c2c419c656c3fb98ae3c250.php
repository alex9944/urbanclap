...
<?php $__env->startSection('content'); ?>
   ...
   <div class="main-content">
                   ...
                   <?php echo Form::open(['url' => url('login'), 'class' => 'form-signin', 'data-parsley-validate' ] ); ?>
                       ...
                       <div class="form-group">
                          <label for="name" class="control-label">Password</label>
                           ...
                           <div class="form-group">
                               <!-- <a href="<?php echo e(url('password/reset')); ?>" class="pull-right forgot ">Forgot password</a>-->
                           </div>
                          <div class="form-group">
            ...
            'data-parsley-trigger'          => 'change focusout'
               ...
               <div class="form-group">
                    <label for="inputreferal" class="control-label">Referal ID (Optional)</label>
						...
						<?php echo Form::text('referral_vendor_code', null, [
                          'class'                         => 'form-control',
                          'placeholder'                   => '',
	...
	<div class="col-md-12 vendorform" style="display: none;">
			...
			<option value="<?php echo e($category->c_id); ?>" <?php if(old('category_id') == $category->c_id): ?> selected <?php endif; ?>><?php echo e($category->c_title); ?> </option>
...
<script type="text/javascript">
$(document).ready(function(){
					var register_type ="<?php echo e(old('user_register')); ?>"; 
