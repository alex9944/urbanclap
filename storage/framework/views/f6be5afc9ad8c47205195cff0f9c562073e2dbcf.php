            ...
            <div class="row">
					...
					<!-- <div class="col-md-12 col-xs-12">
					 ...
					 <div class="col-md-5 col-xs-12">
								<div class="x_panel">
								<form name="actionForm" action="<?php echo e(url('admin/category/destroy')); ?>" method="post" onsubmit="return deleteConfirm();"/> 
                      ...
                      <tbody>
					<?php $menus = app('App\Http\Controllers\CategoryController'); ?>
					<?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="rm<?php echo e($category->c_id); ?>">
                          <td>
						  <input type="checkbox" name="selected_id[]" class="checkbox" value="<?php echo e($category->c_id); ?>"/>				 	  
						  </td>
                          <td><?php echo e($category->c_title); ?>

						  <br />
						  
						  <?php echo e($menus->get_child_category($category->c_id)); ?>

						  </td>
                         <td>
						 <!--<a href="#" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> View </a>-->
                            <a href="javascript:void(0);" class="edit_blog btn btn-info btn-xs" id="<?php echo e($category->c_id); ?>" ><i class="fa fa-pencil"></i></a> 
                            <a href="javascript:void(0);" class="btn btn-danger btn-xs delete_blog" id="<?php echo e($category->c_id); ?>"><i class="fa fa-trash-o"></i> </a></td>
                        </tr> 
					...
					<div class="x_panel" id="add_div" style="">
						...
						<?php endif; ?>
								  ...
								  <!-- Add Form Start-->
						 <form method="POST" action="<?php echo e(url('admin/category/added')); ?>" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div id="reportArea">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" type="text" name="c_title" id="c_title" value="<?php echo e(old('c_title')); ?>"/>
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <textarea name="c_meta_tag" class="form-control" id="c_meta_tag"><?php echo e(old('c_meta_tag')); ?></textarea>
                                    </div>
                                </div>
								<div class="form-group">
                                    <label class="col-sm-2 control-label">Meta Description</label>
                                    <div class="col-sm-6">
                                        <textarea class="form-control" name="c_meta_description" id="c_meta_description"><?php echo e(old('c_meta_description')); ?></textarea>
                                    </div>
                                </div>
					...
					<div class="x_panel" id="edit_div" style=" display:none">
						...
						<div class="x_title">
								  ...
								  <!-- Edit Form Start-->
						 <form method="POST" action="<?php echo e(url('admin/category/updated')); ?>"  enctype="multipart/form-data" class="form-horizontal">
...
function edit_category(){ 
  var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
   var id= $(this).attr('id'); 
	...
	var host="<?php echo e(url('admin/category/getcategory/')); ?>";
	$('#add_div').hide();
	$('#tags_section').hide();
	$('#edit_div').show();
...
{ 
	...
	var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
	$('.image_loader').show();
	$( "#tags_section" ).load( "<?php echo e(url('admin/category/get_tags')); ?>", { "c_id":  id, '_token':CSRF_TOKEN}, function( response, status, xhr ) {
	  $('.image_loader').hide();
	} ).show();
	$('#add_div').hide();
	$('#edit_div').hide();
...
{ 
	...
	var update_url = "<?php echo e(url('admin/category/post_tags')); ?>";
	$('.image_loader').show();
	$( "#tags_section" ).load(
		update_url, 
...
function deleteblog(){ 
	if (confirm("Are you sure delete category?")) {
		var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
		var id= $(this).attr('id'); 
		var host="<?php echo e(url('admin/category/deleted/')); ?>";
		$.ajax({
			type: 'POST',
			data:{'id': id,'_token':CSRF_TOKEN},
			url: host,
			...
			success:function(res)
			{
				if(res.success)
				{
					window.location = "<?php echo e(url('admin/category')); ?>";
				}
				else
				{
					alert(res.msg);
