<div id="mini_cart" class="cart">
	...
	<div class="popup-cart-list">
		<ul class="list-unstyled">
			...
			<li class="alert">
				...
				<div class="media-body">
					...
					<a href="<?php echo e(url('online-order/delete-cart') . '/' . $row->id); ?>" class="close"><i class="fa fa-trash-o"></i></a>
				</div>
			</li>
			<?php } ?>
		</ul>
		...
		<div class="cart-footer">
			<a href="<?php echo e(url('online-order/cart')); ?>" class="btn-cart">VIEW CART</a>
			<a href="<?php echo e(url('online-order/checkout')); ?>" class="btn-checkout">CHECKOUT</a>
		</div>
	</div>
	<?php endif;?>
</div>