...
<head>
  ...
  <script type="text/javascript">
			var asset_path = "{{ url('') }}"; //alert(asset_path);
			tinymce.init({
		...
		<script  type="text/javascript" src="{{ asset('admin-assets/js/typeahead.bundle.js') }}"></script>
<style>
.image_loader{
	display:none;
	position: absolute;
      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          ...
          <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
			...
			<h3 style="color:#d2b800">General</h3>
              <ul class="nav side-menu">
                ...
                <li><a href="{{ url('admin/users') }}"><i class="fa fa-desktop"></i>Admin </a></li>
                <li><a href="{{ url('admin/category') }}"><i class="fa fa-list"></i> Category</a></li>
                <li><a href="{{ url('admin/services') }}"><i class="fa fa-list"></i> Services</a></li>
			   <li><a href="{{ url('admin/questions') }}"><i class="fa fa-bar-chart"></i>Questionnaire</span></a></li>
			...
			<h3 style="color:#d2b800">CMS</h3>
              <ul class="nav side-menu">
                ...
                <li><a href="{{ url('admin/blog') }}"><i class="fa fa-sitemap"></i> Blog </a>

                </li>   
                <li><a href="{{ url('admin/news') }}"><i class="fa fa-newspaper-o"></i> News </a>

                </li>                 
                <li><a href="{{ url('admin/testimonials') }}"><i class="fa fa-frown-o"></i> Testimonials </a>
          ...
          <div class="sidebar-footer hidden-small">
            <a href="{{ url('admin/settings') }}" data-toggle="tooltip" data-placement="top" title="Settings">
...
<script src="{{ asset('admin-assets/js/jquery.bootstrap.wizard.js') }}"></script>
