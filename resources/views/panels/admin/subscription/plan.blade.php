            ...
            <div class="row">
					...
					<!-- <div class="col-md-12 col-xs-12">
					 ...
					 <div class="col-md-5 col-xs-12">
								<div class="x_panel">
								<form name="actionForm" action="{{url('admin/subscription/plan/destroy')}}" method="post" onsubmit="return deleteConfirm();"/> 
					...
					@foreach ($plan as $plan)
                        <tr class="rm{{ $plan->id }}">
                          <td>
						  <input type="checkbox" name="selected_id[]" class="checkbox" value="{{ $plan->id }}"/>				 	  
						  </td>
                          <td>{{ $plan->title }}</td>
                         <td>
						 <!--<a href="#" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> View </a>-->
                            <a href="javascript:void(0);" class="edit_blog btn btn-info btn-xs" id="{{ $plan->id }}" ><i class="fa fa-pencil"></i> Edit </a>
                            <a href="javascript:void(0);" class="btn btn-danger btn-xs delete_blog" id="{{ $plan->id }}"><i class="fa fa-trash-o"></i> Delete </a></td>
                        </tr> 
					@endforeach
					...
					<div class="x_panel" id="add_div" style="">
						...
						<div class="alert alert-success hidden"></div>
								  <!-- Add Form Start-->
						 <form method="POST" action="{{url('admin/subscription/plan/added')}}" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal">
					...
					<div class="x_panel" id="edit_div" style=" display:none">
						...
						<div class="x_title">
								  ...
								  <!-- Edit Form Start-->
						 <form method="POST" action="{{url('admin/subscription/plan/updated')}}"  enctype="multipart/form-data" class="form-horizontal">
