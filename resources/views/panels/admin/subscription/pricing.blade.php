            ...
            <div class="row">
					...
					<!-- <div class="col-md-12 col-xs-12">
					 ...
					 <div class="col-md-5 col-xs-12">
								...
								<form name="actionForm" action="{{url('admin/subscription/pricing/destroy')}}" method="post" onsubmit="return deleteConfirm();"/> 
									<h2>All Pricing <span class="pull-right">
									<?php /*<a href="#" class="btn btn-success btn-xs add_menu"><i class="fa fa-plus"></i> Add </a>  
					...
					@foreach ($pricing as $pricing)
                        ...
                        <tr class="rm{{ $pricing->pid }}">
                          ...
                          <td>{{ $pricing->title }} / {{ $pricing->price }} {{ $currency->symbol }} </td>
                         <td>
                            <a href="javascript:void(0);" class="edit_menu btn btn-info btn-xs" id="{{ $pricing->pid }}" ><i class="fa fa-pencil"></i> Edit </a>
                            <?php /*<a href="javascript:void(0);" class="btn btn-danger btn-xs delete_menu" id="{{ $pricing->pid }}"><i class="fa fa-trash-o"></i> Delete </a>*/?>
							</td>
                        </tr> 
					@endforeach
						...
						<div class="alert alert-success hidden"></div>
						 ...
						 <form method="POST" action="{{url('admin/subscription/pricing/added')}}" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="form-group">
                                    <label class="col-sm-2 control-label"> Sorting Order</label>
                                    <div class="col-sm-6">
                                        <input class="form-control" type="text" name="order_by" id="order_by" value="{{ old('order_by') }}"/>
						 ...
						 <form method="POST" action="{{url('admin/subscription/pricing/updated')}}"  enctype="multipart/form-data" class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="form-group">
                                    <label class="col-sm-2 control-label"> Description</label>
                                    <div class="col-sm-6">
                                        <textarea class="form-control" rows="5" name="description" id="edit_description">{{ old('description') }}</textarea>
										<span class="error">{{ ($errors->has('description')) ? $errors->first('description') : ''}}</span>
                                    </div>
                                </div>
