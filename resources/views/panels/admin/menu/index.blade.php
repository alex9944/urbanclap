                            ...
                            <div id="reportArea">
								...
								<div class="form-group hidden">
								 ...
								 <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
										<?php /*<input type="radio" value="is_home" name="dynamic_page_type"> Home
								...
								<div class="form-group hidden">
                                    ...
                                    <div class="col-sm-6">
                                        <input class="form-control" type="text" name="order_by" id="order_by" value="0" />
					   ...
					   <div class="form-group">
								...
								<div class="form-group hidden">
					             ...
					             <div class="form-group hidden">
                                    <label class="col-sm-2 control-label">Menu Order</label>
                                    <div class="col-sm-6">
                                        <input class="form-control" type="text" name="order_by" id="edit_order_by" value="0" />
										<span class="error">{{ ($errors->has('order_by')) ? $errors->first('order_by') : ''}}</span>
                                    </div>
                                </div>
								<input type="hidden" name="_token" value="{{csrf_token()}}">
