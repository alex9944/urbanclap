		...
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<div class="x_panel" id="vieworder">
					...
					<form id="listForm" method="post" action="{{ url('admin/customer-orders/'.$order_booking->id) }}" class="form-horizontal">
						...
						<div class="form-group required">
							...
							<a href="{{ url('admin/customer-orders') }}" class="btn btn-default">Back</a>
							</div>
						</div>
					</form>
				</div>
