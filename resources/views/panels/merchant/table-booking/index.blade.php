	...
	<div class="row">
					...
					<div class="x_panel">-->
						...
						<div class="col-md-6 col-xs-12">
							<div class="x_panel">
								<form name="actionForm" action="{{url('merchant/table-booking/destroy_all')}}" method="post" onsubmit="return deleteConfirm();"/> 
								<h2>Listing <span class="pull-right"><a href="{{url('merchant/table-booking')}}" class="btn btn-success btn-xs add_blog"><i class="fa fa-plus"></i> Add </a>  
								...
								<table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
									...
									<tbody>
										...
										<tr class="rm{{ $table_booking_setting->id }}">
											...
											<td>{{ $table_booking_setting->status }}</td>
											<td>
