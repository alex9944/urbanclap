...
<div class="services_app__block">
	<ul class="nav nav-pills">
		<li><a href="{{ url('merchant/online-order/menu-items') }}">Food</a></li>
	...
	<div class="tab-content clearfix">            
		<div class="tab-pane active" id="shop">
			...
			<div class="shop_block">
				<div class="divbox">
					<a href="{{ url('merchant/table-booking/enable-service') }}" class="ui-link">
			...
			<div class="appmt_block">
				<div class="divbox">
					<a href="{{ url('merchant/table-booking/disable-service') }}" class="ui-link active">
						<span class="notify-badge " style="display: none;"><i class="fa fa-check" aria-hidden="true"></i></span>
			...
			<?php
								$url = url('merchant/table-booking/add');
								$add = 'Add';
								if(isset($table_booking_settings->id))
								{
									$url = url('merchant/table-booking/update');
									$add = 'Edit';
								}
								?>
				...
				<form id="listForm" method="post" action="{{ $url }}" class="form-inline">
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<?php
								if(isset($table_booking_settings->time_interval))
									$time_interval = old('time_interval', $table_booking_settings->time_interval);
								else
									$time_interval = old('time_interval');
								?>
								<input class="form-control tb_perslot_text" type="text" name="time_interval" id="time_interval" value="{{ $time_interval }}"/> <i class="fa fa-info-circle vertical_align" aria-hidden="true"></i>
