					...
					<!-- <div class="col-md-12 col-xs-12">
					 ...
					 <div class="col-md-5 col-xs-12">
								<div class="x_panel">
									...
									<h2>All Category <span class="pull-right"><a href="#" class="btn btn-success btn-xs"><i class="fa fa-plus"></i> Add </a>  <a href="#" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete All</a></span></h2>
								 <div class="x_title">
								  </div>
								  
								  <table id="datatable-checkbox" class="table table-striped table-bordered bulk_action">
                      <thead>
                        <tr><th><input type="checkbox" id="check-all" class="flat"></th>						 
                          <th>Title</th>
                          <th>Action</th>                         
                        </tr>
                      </thead>
...
<tr>
						...
						<tr>
                          ...
                          <td>Tiger NixonTiger NixonTiger Nixon</td>
                         <td><a href="#" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                            <a href="#" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a></td>
                        </tr>  
<tr>
