					...
					<div class="col-md-11 col-xs-12">
						...
						<div class="x_panel">
							...
							<table class="table table-striped table-bordered bulk_action">
							   ...
							   <td>
								@if($last_subscription->paid_amount)
								{{$last_subscription->currency->symbol . $last_subscription->paid_amount}}
								@else
								{{$last_subscription->paid_amount}}
								@endif
								</td>
							   </tr>
							</table>
						...
						<div class="row">
							...
							?>
							<form name="subscriptionForm" action="{{url('merchant/renew-subscription')}}" id="subscriptionForm" method="post" role="form">
							...
							<div style="clear:both;" class="text-center">
								...
								<h3 class="heading2">Payment Method</h3>
								...
								<h3 class="heading2">Subscription Term</h3>
								...
								<h4>
									Payable Amount <?php echo $last_subscription->currency->symbol; ?>
								...
								<ul class="list-inline">
									...
									@endif
									<li>
										<button type="submit" class="btn btn-default next_3">Renew Current Plan</button>
									</li>
								</ul>
							</div>
