    ...
    <div class="page-title">
            ...
            <div class="row">
					...
					@foreach ($orders as $orders)
                        <tr class="rm{{ $orders->b_id }}">
						 ...
						 <!--<a href="#" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> View </a>-->
                            <a href="javascript:void(0);" class="view_order btn btn-info btn-xs" id="{{ $orders->id }}" ><i class="fa fa-folder"></i> View orders </a>
							   <a href="javascript:void(0);" class="edit_blog btn btn-info btn-xs" id="{{ $orders->id }}" ><i class="fa fa-folder"></i> View items</a>
						...
						<div class="alert alert-success hidden"></div>
						 ...
						 <form method="POST" action="{{url('admin/blog/added')}}" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div id="fil">                                
								...
								<tr><th>Product Title</th><th>
								Merchant</th><th>Qty</th><th>total</th><th>View </th></tr>
								</table>
                            </div>
                    </form>
					...
					<div class="x_panel" id="edit_div" style=" display:none">
					 ...
					 <table class="table table-striped table-bordered bulk_action"><tr><th>Product Title</th><th>Merchant</th><th>Qty</th><th>Total</th><th>View </th></tr>
					 <tbody id="reportArea"></tbody>
					 </table>
