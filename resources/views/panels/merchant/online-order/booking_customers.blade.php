						...
						<table id="bookings" class="table table-striped table-bordered bulk_action">
							...
							<tbody>
								...
								<tr>
									...
									<td>{{$booking->main_order->name}}</td>
									<td>{{$booking->main_order->email}}</td>
									<td>{{$booking->main_order->phone_number}}</td>
									<td>{{$booking->total_items}}</td>
									<td>{{$booking->total_amount}}</td>
									<td>{{$booking->payment_status}}</td>
									<td>{{ $merchant_order_status[$booking->order_status]['name']}}</td>
									<td>
										<a href="{{ url('merchant/online-order/booking-customers/'.$booking->id) }}" class="btn btn-primary btn-xs">Detail</a> 
