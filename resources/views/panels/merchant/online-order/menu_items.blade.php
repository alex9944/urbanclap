            ...
            <div class="row">
					...
					<!-- <div class="col-md-12 col-xs-12">
					 ...
					 <div class="col-md-7 col-xs-12">
								<div class="x_panel">
								<form name="actionForm" action="{{url('merchant/online-order/menu_item_destroy_all')}}" method="post" onsubmit="return deleteConfirm();"/> 
									<h2>Menu Item Lists <span class="pull-right"><a href="{{url('merchant/online-order/menu-items')}}" class="btn btn-success btn-xs add_blog"><i class="fa fa-plus"></i> Add </a>  
								 ...
								 <div class="x_title">
								  ...
								  <table id="datatable-checkbox"   cellspacing="0" width="100%" class="display table table-striped table-bordered bulk_action">
                      <thead>
                        <tr><th>
					...
					<div class="x_panel" id="add_div" style="">
						<?php
							...
							if(old('id'))
							{
								$url = url('merchant/online-order/update-menu-item');
								$add = 'Edit';
							}
						?>
