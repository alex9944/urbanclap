            ...
            <div class="row">
					...
					<!-- <div class="col-md-12 col-xs-12">
					 ...
					 <div class="col-md-5 col-xs-12">
								<div class="x_panel">
								<form name="actionForm" action="{{url('admin/ads/duration/destroy')}}" method="post" onsubmit="return deleteConfirm();"/> 
									<h2>All Ads Duration <span class="pull-right"><a href="#" class="btn btn-success btn-xs add_blog"><i class="fa fa-plus"></i> Add </a>  
					...
					<div class="x_panel" id="add_div" style="">
						<h2>Add Ads Duration </h2>
						<div class="x_title">
						</div>
						@if(Session::get('message')) <div class="alert alert-success" role="alert">{{Session::get('message')}} </div>@endif 
						<div class="alert alert-success hidden"></div>
								  <!-- Add Form Start-->
						 <form method="POST" action="{{url('admin/ads/duration/added')}}" accept-charset="UTF-8" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div id="reportArea">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-3 control-label"> Month / Days</label>
                                    <div class="col-sm-6">
									<select name="days_month" id="days_month"  class="form-control">  
					...
					<div class="x_panel" id="edit_div" style=" display:none">
						<h2>Edit Ads Duration </h2>
						<div class="x_title">
						</div>					
								  <!-- Edit Form Start-->
						 <form method="POST" action="{{url('admin/ads/duration/updated')}}"  enctype="multipart/form-data" class="form-horizontal">
...
// EDit Blog
 $(document).on("click", ".edit_blog", edit_blogs);
   ...
   var id= $(this).attr('id'); 
	...
	var host="{{ url('admin/ads/duration/getduration/') }}";
	$('#add_div').hide();
...
function renderListform(res){ 
	...
	$('#edit_title').val(res.view_details.duration_time);
 ...
 $(document).on("click", ".delete_blog", deleteblog);
  ...
  var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
   var id= $(this).attr('id'); 
	var host="{{ url('admin/ads/duration/deleted/') }}";
	$.ajax({
		type: 'POST',
		data:{'id': id,'_token':CSRF_TOKEN},
		url: host,
...
function deleteStatus(res){ 
 if (confirm("Are you sure delete duration?")) {
...
function deleteConfirm(){
	if($('.checkbox:checked').length == ''){
		alert('Please check atleast one duration');
		return false;
	}	
}
